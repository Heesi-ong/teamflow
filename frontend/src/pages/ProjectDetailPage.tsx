      ...
      {data && (
        <div className="mt-4 rounded border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 flex gap-2">
            ...
            <Link to={`/projects/${data.id}/documents`} className="inline-block rounded bg-blue-600 px-3 py-2 text-white">
              문서
            </Link>
            <Link to={`/projects/${data.id}/files`} className="inline-block rounded bg-blue-600 px-3 py-2 text-white">
              파일
            </Link>
